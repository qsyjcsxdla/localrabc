        ...
        <el-row>
            <el-col :span="10">
                <div class="grid-content ">
                    ...
                    <el-form ref="form" :data="form" label-width="120px" class="contain-box" :inline="true"  >
                        ...
                        <el-form-item label="职位等级：" >
                            <span class="input-width2"><el-rate :data="form.prank"></el-rate></span>
                        </el-form-item>
...
import {mapState,mapGetters,mapActions} from 'vuex';
  export default {
    data() {
        return{
          // tableData: this.$store.commit.updateTableData
          }
        },
    computed: {
        ...mapState({
